            ...
            <div className="info">
                ...
                <div className="postinfo">
                                    ...
                                    <div key={comment.id} className='caption-card'>
                                        ...
                                        <div>
                                            ...
                                            {comment.numOfReplies > 0 &&
                                                <ViewReply comment={comment} setContentType={setContentType} setItemId={setItemId} setReplyTo={setReplyTo}></ViewReply>}
                                        </div>
                                    </div>)
                            })}
                        </div>
                    ...
                    {contectType == 'comment' && actionType == 'post'? (
                            ...
                            <CreateReplyForm item={allComments[itemId]} replyTo={replyTo}></CreateReplyForm>
                        )
                    }
