...
def seed_users():
    objects = [
        User(first_name = "Demo", last_name = "User", username = "demouser", biography = "I'm a very cool user.", email = "demouser@gmail.com", password = "password1234", preview_image = "https://www.meme-arsenal.com/memes/4780e9dca641c9eb02521a54d8995c61.jpg"),
        ...
        User(first_name = "Huda", last_name = "Kattan", username = "hudabeauty", biography = "biography 2", email = "hudabeauty@gmail.com", password = "password1234", preview_image = "https://image.cnbcfm.com/api/v1/image/106371890-1580835090681huda-3.jpg"),
