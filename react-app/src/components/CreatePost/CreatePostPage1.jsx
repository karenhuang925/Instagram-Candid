...
function CreatePostPage1({ images, setImages }) {
    ...
    const handleOnChange = (e, index) => {
        ...
        if(inputsOnChange[index][0].endsWith("")) inputsOnChange[index][1] = false;
        if(!inputsOnChange[index][0].endsWith("")) inputsOnChange[index][1] = true;
