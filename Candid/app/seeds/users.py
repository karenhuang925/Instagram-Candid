...
def seed_users():
    ...
    # user1 = User(first_name = "Whindersson",
    #             last_name = "Nunes",
    #             username = "whindersonnunes",
    #             biography = "biography 1",
    #             email = "whindersonnunes@gmail.com",
    #             password = "password1234",
    #             preview_image = "https://upload.wikimedia.org/wikipedia/commons/f/f6/Whindersson_Nunes_em_2019.png"
    #             )
    # user2 = User(first_name = "Huda",
    #             last_name = "Kattan",
    #             username = "hudabeauty",
    #             biography = "biography 2",
    #             email = "hudabeauty@gmail.com",
    #             password = "password1234",
    #             preview_image = "https://image.cnbcfm.com/api/v1/image/106371890-1580835090681huda-3.jpg"
    #             )

    # user3 = User(first_name = "Eleanora",
    #             last_name = "Pons",
    #             username = "lelepons",
    #             biography = "biography 3",
    #             email = "lelepons@gmail.com",
    #             password = "password1234",
    #             preview_image = "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e7/Lele_Pons_2019_by_Glenn_Francis.jpg/1200px-Lele_Pons_2019_by_Glenn_Francis.jpg"
    #             )
